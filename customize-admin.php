...
//remove wordpress Remove Adminbar Logo
function annointed_admin_bar_remove() {
	global $wp_admin_bar;

	if (get_option('ca_remove_admin_bar') != ''){
		/* Remove their stuff */
